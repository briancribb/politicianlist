					...
					<div className="card-body">
						<div className="d-sm-flex">
							<div className="member-photo-wrapper mb-2 mb-sm-0">
								<img className="member-photo img-fluid mx-auto ml-sm-0" onError={this._handleImageError} src={member.member_photo_link} loading="lazy" alt={'Photo of ' + this._getMemberName(member)} />
